...
options_ = [];
M_.fname = 'inflation_cg_expectations';
...
M_.block_structure.variable_reordered = [ 10 11 7 8 9 5 2 6 1 3 4];
M_.block_structure.equation_reordered = [ 10 11 4 2 3 1 6 9 5 7 8];
...
M_.dynamic_g1_sparse_rowval = int32([5 6 9 10 11 5 9 3 5 6 6 7 1 4 8 9 1 4 8 9 2 4 2 3 3 7 1 2 10 11 7 11 8 7 8 10 ]);
M_.dynamic_g1_sparse_colval = int32([2 2 6 10 11 12 12 13 13 13 14 14 15 15 15 15 16 16 17 17 18 18 19 19 20 20 21 21 21 21 22 22 23 25 26 34 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 3 3 3 3 4 4 4 4 5 6 8 11 13 17 19 21 23 25 27 31 33 34 34 35 36 36 36 36 36 36 36 36 37 ]);
...
M_.block_structure_stat.block(4).g1_sparse_rowval = int32([1 2 2 ]);
M_.block_structure_stat.block(4).g1_sparse_colval = int32([1 1 2 ]);
M_.block_structure_stat.block(4).g1_sparse_colptr = int32([1 3 4 ]);
...
M_.static_g1_sparse_rowval = int32([5 8 9 3 6 6 7 1 4 9 1 4 8 9 2 4 2 3 3 7 1 2 10 11 7 11 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 2 3 3 4 4 4 5 5 6 6 7 7 8 8 9 9 10 10 10 10 11 11 ]);
M_.static_g1_sparse_colptr = int32([1 4 6 8 11 13 15 17 19 21 25 27 ]);
...
save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_expectations_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
