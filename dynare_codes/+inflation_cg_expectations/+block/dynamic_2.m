...
residual=NaN(6, 1);
  ...
  residual(3)=(y(17))-(params(6)*y(6)+(1-params(6))*(y(12)*params(7)+y(15)*12*params(8)));
  residual(4)=(y(12))-(12*(y(13)-y(2)));
  residual(5)=(y(14))-(params(3)*params(2)*y(25)+y(20)*(1-params(3)*params(2))+params(12)*y(22));
  residual(6)=(y(15))-(y(26)-params(4)*(y(17)/12-y(23)/12));
if nargout > 3
    g1_v = NaN(21, 1);
g1_v(1)=(-params(3));
g1_v(2)=12;
