...
M_.endo_names(11) = {'exp_h'};
M_.endo_names_tex(11) = {'exp\_h'};
M_.endo_names_long(11) = {'exp_h'};
...
M_.param_names(10) = {'rho_e'};
M_.param_names_tex(10) = {'rho\_e'};
M_.param_names_long(10) = {'rho_e'};
M_.param_names(11) = {'phi_e'};
M_.param_names_tex(11) = {'phi\_e'};
M_.param_names_long(11) = {'phi_e'};
M_.param_names(12) = {'omega'};
M_.param_names_tex(12) = {'omega'};
M_.param_names_long(12) = {'omega'};
M_.param_names(13) = {'h'};
M_.param_names_tex(13) = {'h'};
M_.param_names_long(13) = {'h'};
...
M_.mapping.tot.eqidx = [1 2 10 11 ];
M_.mapping.exp_h.eqidx = [7 11 ];
...
M_.block_structure.block(1).variable = [ 10 11];
...
M_.block_structure.block(2).equation = [ 4 2 3 1 6 8 9 5 7];
M_.block_structure.block(2).variable = [ 7 8 9 5 2 6 4 1 3];
M_.block_structure.block(2).is_linear = true;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [2 3 4 0 0 0 7 8 9 10 11 12 16 17 18 ];
M_.block_structure.block(1).g1_sparse_rowval = int32([]);
M_.block_structure.block(1).g1_sparse_colval = int32([]);
M_.block_structure.block(1).g1_sparse_colptr = int32([]);
M_.block_structure.block(2).g1_sparse_rowval = int32([2 5 4 3 1 6 2 5 6 3 4 1 3 4 6 4 5 2 6 3 3 6 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([2 2 3 4 7 7 8 8 8 9 9 10 10 10 10 11 11 12 12 16 17 18 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 3 4 5 5 5 7 10 12 16 18 20 20 20 20 21 22 23 ]);
M_.block_structure.variable_reordered = [ 10 11 7 8 9 5 2 6 4 1 3];
M_.block_structure.equation_reordered = [ 10 11 4 2 3 1 6 8 9 5 7];
...
M_.dynamic_g1_sparse_rowval = int32([5 6 8 9 10 11 5 9 3 5 6 6 7 1 4 8 9 1 4 8 9 2 4 2 3 3 7 1 2 10 11 7 11 8 7 8 10 ]);
M_.dynamic_g1_sparse_colval = int32([2 2 4 6 10 11 12 12 13 13 13 14 14 15 15 15 15 16 16 17 17 18 18 19 19 20 20 21 21 21 21 22 22 23 25 26 34 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 3 3 4 4 5 5 5 5 6 7 9 12 14 18 20 22 24 26 28 32 34 35 35 36 37 37 37 37 37 37 37 37 38 ]);
...
M_.block_structure_stat.block(4).equation = [ 8 9];
M_.block_structure_stat.block(4).variable = [ 6 4];
...
M_.block_structure_stat.block(6).equation = [ 4 2];
M_.block_structure_stat.block(6).variable = [ 7 8];
...
M_.block_structure_stat.block(7).equation = [ 6 7 3];
M_.block_structure_stat.block(7).variable = [ 2 3 9];
M_.block_structure_stat.variable_reordered = [ 1 10 11 6 4 5 7 8 2 3 9];
M_.block_structure_stat.equation_reordered = [ 5 10 11 8 9 1 4 2 6 7 3];
...
M_.static_g1_sparse_rowval = int32([5 8 9 3 6 6 7 1 4 8 9 1 4 8 9 2 4 2 3 3 7 1 2 10 11 7 11 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 2 3 3 4 4 4 4 5 5 6 6 7 7 8 8 9 9 10 10 10 10 11 11 ]);
M_.static_g1_sparse_colptr = int32([1 4 6 8 12 14 16 18 20 22 26 28 ]);
...
options_.order = 1;
var_list_ = {'infl';'gdp';'tot';'nomint';'exp_h'};
[info, oo_, options_, M_] = stoch_simul(M_, options_, oo_, var_list_);
irf_no_habit = oo_.irfs;
set_param_value('h', 0.7);
options_.irf = 24;
options_.noprint = true;
options_.order = 1;
var_list_ = {'infl';'gdp';'tot';'nomint';'exp_h'};
[info, oo_, options_, M_] = stoch_simul(M_, options_, oo_, var_list_);
irf_habit = oo_.irfs;
figure('Name', 'IRF Comparison: Habit Formation vs No Habit', ...
       'Position', [100, 100, 1200, 700]);
vars   = {'infl',      'gdp',  'tot',                   'nomint',                'exp_h'};
titles = {'Inflation', 'GDP',  'Terms of Trade (shock)', 'Nominal Interest Rate', 'Household Inflation Expectations'};
for i = 1:5
subplot(2, 3, i);
field = [vars{i} '_totsh'];
plot(1:24, irf_no_habit.(field), 'b-',  'LineWidth', 2.0); hold on;
plot(1:24, irf_habit.(field),    'r--', 'LineWidth', 2.0);
yline(0, 'k:', 'LineWidth', 0.8);
title(titles{i}, 'FontSize', 12);
xlabel('Months after shock', 'FontSize', 10);
if i == 1
legend('No Habit (h=0)', 'Habit (h=0.7)', ...
...
sgtitle('C-G Expectations Model: Effect of Habit Formation', 'FontSize', 13);
...
save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'inflation_cg_habit_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
